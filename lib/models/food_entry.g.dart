...
NutritionEstimate _$NutritionEstimateFromJson(Map<String, dynamic> json) =>
    NutritionEstimate(
      ...
      monoFatGrams: (json['monoFatGrams'] as num?)?.toInt(),
      polyFatGrams: (json['polyFatGrams'] as num?)?.toInt(),
...
Map<String, dynamic> _$NutritionEstimateToJson(NutritionEstimate instance) =>
    <String, dynamic>{
      ...
      'monoFatGrams': instance.monoFatGrams,
      'polyFatGrams': instance.polyFatGrams,
